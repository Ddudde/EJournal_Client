...
@observer
export default class NewsPor extends Component {
    ...
    private errText: string = "Новостей нет... Ждите новой информации.";
	...
	public UNSAFE_componentWillMount(): void {
        ...
        NewsMain.setActNew(0);
        NewsMain.setTyp(this.type);
    }

    public componentDidMount(): void {
        console.log("I was triggered during componentDidMount NewsPor");
    ...
    public render(): ReactElement {
        return <div className={newsCSS.header}>
            ...
            {Object.getOwnPropertyNames(this.newsInfo[this.type]).length == 0 && !(this.cState.auth && this.cState.role == 4) ?
                    <ErrFound text={this.errText}/>
                :
                    <div className={newsCSS.block}>
                        <section className={newsCSS.center_colum}>
                            {(this.cState.auth && this.cState.role == 4) && NewsMain.getAdd(this.inps, this.forceUpdate)}
